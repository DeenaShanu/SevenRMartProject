...
public class SubCategoryPage {
	...
	@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/Subcategory/add']")private
	WebElement newSubcategoryBtn;
	@FindBy(id="cat_id")private WebElement selectCategory;
	@FindBy(id="subcategory")private WebElement subCategory;
	
	@FindBy(id="main_img")private WebElement image;
	@FindBy(xpath="//input[@type='file']")private WebElement imageRobotEdit;
	...
	//edit
	@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/Subcategory/edit?edit=3701&page_ad=1']")private WebElement edit;
