...
public class ManageNewsPage {
	...
	@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/news/add']")private WebElement addnew_News;
	...
	@FindBy(xpath="//a[@href='javascript:void(0)']")private WebElement clickSearchBtn;
	@FindBy(xpath="//input[@placeholder='Title']")private WebElement searchField;
	@FindBy(xpath="//button[@value='sr']")private WebElement searchBtn;
	
	@FindBy(xpath="//button[@data-dismiss='alert']")private WebElement alertMsg;
	@FindBy(xpath="//table[@class='table table-bordered table-hover table-sm']/tbody/tr[1]/td[1]")private WebElement tableData;
