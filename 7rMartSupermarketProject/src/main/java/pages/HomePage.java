...
public class HomePage {
	...
	@FindBy(xpath="//li[@class='nav-item dropdown']")private WebElement usrNameLink;
	@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/logout']")private WebElement logOutBtn;
