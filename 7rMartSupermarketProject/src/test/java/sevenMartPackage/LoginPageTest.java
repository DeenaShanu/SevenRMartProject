...
public class LoginPageTest extends Base {
	...
	@Test(description = "Verify whether user is able to login with valid credentials", priority = 1, groups = {
			"SmokeTest" }, dataProvider = "credentials")
	public void verifyUserLoginWithValidCredentials(String usrnam, String pswd) throws IOException {
		...
		loginPage.enterUsernameOnUsernameField(usrnam).enterPasswordOnPasswordField(pswd);
	...
	@Test(description = "Verify whether user is able to login with Valid username and invalid paswrd", priority = 2, groups = {
			"SmokeTest" })
